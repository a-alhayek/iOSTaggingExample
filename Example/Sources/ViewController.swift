...
final class ViewController: UIViewController {
    ...
    init() {
        ...
        exampleItems.append(Item(title: "Tag example", description: "Tagging example of TwitterTextKit usage") { (viewController) in
            let swiftViewController = TagViewController()
            // See `Settings.bundle`.
